...
import { slideExpandCollapseAnimation } from "src/app/shared/animations/animations";
import { getDate } from "src/app/shared/helpers/date.helper";
import { FileRowForm, SentHomeworksForPath } from "../../models";
...
@Component({
  ...
  animations: [trigger("detailExpand", slideExpandCollapseAnimation())]
})
